...
El script de prueba de rendimiento ya se encuentra en test_performance.js.
...
Para ejecutar el test (asumiendo que está en la raíz y se llama test_performance.js)
